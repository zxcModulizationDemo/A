...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zxcModulizationDemo/A"
  ...
  s.author             = { "rain1988" => "zxc115514196@163.com" }
  ...
  s.source       = { :git => "https://github.com/zxcModulizationDemo/A.git", :tag => s.version.to_s }
